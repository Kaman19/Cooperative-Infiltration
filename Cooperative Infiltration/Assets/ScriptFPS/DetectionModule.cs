    ...
    public virtual void HandleTargetDetection(Actor actor, Collider[] selfColliders)
    {
        ...
        foreach (Actor otherActor in m_ActorsManager.actors)
        {
            if (otherActor.affiliation != actor.affiliation)
            {
                ...
                {
                    // Check for obstructions  on garde cette détéction mais on rajoutera un raucast en plus pour voir si il est en face du joueur dans le cas ou il sera acroupis ou qu'il marche
